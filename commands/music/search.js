...
module.exports = {
        ...
        async execute(client, message, args) {
            if (!args[0]) return message.channel.send(`Please enter a valid search query, ${message.author}`);
        ...
        embed.setTimestamp();
        embed.setFooter('by chrstndev', message.author.avatarURL({ dynamic: true }));
